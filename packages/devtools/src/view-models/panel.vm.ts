...
import type { IconName } from "../ports/render-primitives.port.js";
...
/**
 * Creates an empty PanelViewModel (frozen for immutability).
 * Use createMutablePanelViewModel() for TUI environments that don't support frozen objects.
 */
...
/**
 * Creates a mutable empty PanelViewModel for TUI environments.
 * OpenTUI's React renderer doesn't support frozen objects.
 */
export function createMutablePanelViewModel(): PanelViewModel {
  const tabs: TabViewModel[] = [
    {
      id: "graph",
      label: "Graph",
