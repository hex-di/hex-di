 ...
 * ```typescript
 * import { toJSON, filterGraph, byLifetime } from '@hex-di/devtools-core';
 *
 ...
 * ```typescript
 * import { toJSON, filterGraph, byLifetime, toMermaid } from '@hex-di/devtools-core';
 *
 ...
 * ```typescript
 * import { toJSON, filterGraph, byPortName } from '@hex-di/devtools-core';
 *
