...
], const TLifetime extends Lifetime = "scoped">(config: FlowAdapterConfig<TProvides, TRequires, TActivities, TLifetime>): Result<FlowAdapter<TProvides, TRequires, TLifetime>, FlowAdapterError>;
/**
 ...
 */
export declare function computeFlowMetadata(machine: MachineAny, activityPortNames?: readonly string[]): Result<FlowAdapterMetadata, FlowAdapterError>;
/**
