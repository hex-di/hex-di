...
export type IsAsyncFactory<TFactory> = TFactory extends (...args: never[]) => infer R ? [
	...
	never
] ? false : R extends Promise<unknown> ? true : false : false;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export interface FactoryConfig<TProvides extends Port<unknown, string>, TRequires extends readonly Port<unknown, string>[], TFactory extends (deps: PortDeps<TRequires>) => InferService<TProvides> | Promise<InferService<TProvides>>> extends BaseUnifiedConfig<TProvides, TRequires> {
	/**
	 * Factory function that creates the service instance.
	 *
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, TFactory extends (deps: ResolvedDeps<never>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	requires?: undefined;
	lifetime?: undefined;
	clonable?: undefined;
}): Adapter<TProvides, never, Singleton, IsAsyncFactory<TFactory> extends true ? Async : Sync, False, EmptyRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TRequires extends readonly Port<unknown, string>[], TFactory extends (deps: PortDeps<TRequires>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly requires: TRequires;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	lifetime?: undefined;
	clonable?: undefined;
}): Adapter<TProvides, TupleToUnion<TRequires>, Singleton, IsAsyncFactory<TFactory> extends true ? Async : Sync, False, TRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TLifetime extends Lifetime, TFactory extends (deps: ResolvedDeps<never>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly lifetime: TLifetime;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	requires?: undefined;
	clonable?: undefined;
}): Adapter<TProvides, never, EnforceAsyncLifetime<TFactory, TLifetime>, IsAsyncFactory<TFactory> extends true ? Async : Sync, False, EmptyRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TRequires extends readonly Port<unknown, string>[], const TLifetime extends Lifetime, TFactory extends (deps: PortDeps<TRequires>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly requires: TRequires;
	readonly lifetime: TLifetime;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	clonable?: undefined;
}): Adapter<TProvides, TupleToUnion<TRequires>, EnforceAsyncLifetime<TFactory, TLifetime>, IsAsyncFactory<TFactory> extends true ? Async : Sync, False, TRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TClonable extends boolean, TFactory extends (deps: ResolvedDeps<never>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly clonable: TClonable;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	requires?: undefined;
	lifetime?: undefined;
}): Adapter<TProvides, never, Singleton, IsAsyncFactory<TFactory> extends true ? Async : Sync, TClonable, EmptyRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TRequires extends readonly Port<unknown, string>[], const TClonable extends boolean, TFactory extends (deps: PortDeps<TRequires>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly requires: TRequires;
	readonly clonable: TClonable;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	lifetime?: undefined;
}): Adapter<TProvides, TupleToUnion<TRequires>, Singleton, IsAsyncFactory<TFactory> extends true ? Async : Sync, TClonable, TRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TLifetime extends Lifetime, const TClonable extends boolean, TFactory extends (deps: ResolvedDeps<never>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly lifetime: TLifetime;
	readonly clonable: TClonable;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
	requires?: undefined;
}): Adapter<TProvides, never, EnforceAsyncLifetime<TFactory, TLifetime>, IsAsyncFactory<TFactory> extends true ? Async : Sync, TClonable, EmptyRequires>;
/**
 ...
 * @typeParam TFactory - The factory function type
 */
export declare function createAdapter<TProvides extends Port<unknown, string>, const TRequires extends readonly Port<unknown, string>[], const TLifetime extends Lifetime, const TClonable extends boolean, TFactory extends (deps: PortDeps<TRequires>) => InferService<TProvides> | Promise<InferService<TProvides>>>(config: {
	readonly provides: TProvides;
	readonly requires: TRequires;
	readonly lifetime: TLifetime;
	readonly clonable: TClonable;
	readonly factory: TFactory;
	readonly finalizer?: (instance: InferService<TProvides>) => void | Promise<void>;
}): Adapter<TProvides, TupleToUnion<TRequires>, EnforceAsyncLifetime<TFactory, TLifetime>, IsAsyncFactory<TFactory> extends true ? Async : Sync, TClonable, TRequires>;
/**
