...
import type { ContainerInternalState, ContainerSnapshot as RuntimeSnapshot } from "@hex-di/runtime";
import type {
  ContainerKind,
  ContainerPhase,
  ContainerSnapshot,
 ...
 * - child: Has parentState (inherited from parent container)
 * - root: No parentState, has childScopes array
...
export function detectContainerKindFromInternal(
  ...
  // Child containers have parentState
...
function buildRootSnapshot(
  base: { singletons: readonly SingletonEntry[]; scopes: ScopeTree; isDisposed: boolean },
