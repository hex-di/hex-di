...
export class DisposedScopeError extends ContainerError {
    ...
    constructor(portName) {
        super(`Cannot resolve port '${portName}' from a disposed scope. ` +
            `The scope has already been disposed and cannot be used for resolution.`);
        this.code = "DISPOSED_SCOPE";
        this.isProgrammingError = true;
        this.portName = portName;
    }
}
...
export class ScopeRequiredError extends ContainerError {
     ...
     */
    constructor(portName) {
        super(`Cannot resolve scoped port '${portName}' from the root container. ` +
...
export class AsyncFactoryError extends ContainerError {
    ...
    constructor(portName, cause) {
        ...
        this.code = "ASYNC_FACTORY_FAILED";
        this.isProgrammingError = false;
        this.portName = portName;
        this.cause = cause;
    }
...
export class AsyncInitializationRequiredError extends ContainerError {
     ...
     */
    constructor(portName) {
        super(`Cannot resolve async port '${portName}' synchronously. ` +
            `Use resolveAsync() or call container.initialize() first.`);
        this.code = "ASYNC_INIT_REQUIRED";
        this.isProgrammingError = true;
        this.portName = portName;
    }
}
