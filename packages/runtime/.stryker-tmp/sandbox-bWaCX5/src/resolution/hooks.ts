...
export function sealHooks(hooks: ResolutionHooks): ImmutableHooksConfig {
  if (stryMutAct_9fa48("1957")) {
    ...
    stryCov_9fa48("1957");
    const sealed: ImmutableHooksConfig = stryMutAct_9fa48("1958")
      ? {}
      : (stryCov_9fa48("1958"),
        {
          beforeResolve: hooks.beforeResolve,
          afterResolve: hooks.afterResolve,
          sealed: stryMutAct_9fa48("1959") ? false : (stryCov_9fa48("1959"), true),
        });
...
export function isSealed(hooks: ResolutionHooks): hooks is ImmutableHooksConfig {
  if (stryMutAct_9fa48("1960")) {
    ...
    stryCov_9fa48("1960");
    return stryMutAct_9fa48("1963")
      ? (hooks as ImmutableHooksConfig).sealed !== true
      : stryMutAct_9fa48("1962")
        ? false
        : stryMutAct_9fa48("1961")
          ? true
          : (stryCov_9fa48("1961", "1962", "1963"),
            (hooks as ImmutableHooksConfig).sealed ===
              (stryMutAct_9fa48("1964") ? false : (stryCov_9fa48("1964"), true)));
  }
}
