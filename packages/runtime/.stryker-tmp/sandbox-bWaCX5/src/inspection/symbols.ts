...
export const INTERNAL_ACCESS = Symbol.for(
  stryMutAct_9fa48("1800") ? "" : (stryCov_9fa48("1800"), "hex-di/internal-access")
);
 ...
 * ```
 */
export const TRACING_ACCESS = Symbol.for(
  stryMutAct_9fa48("1801") ? "" : (stryCov_9fa48("1801"), "hex-di/tracing-access")
);
 ...
 * @internal
 */
export const ADAPTER_ACCESS = Symbol.for(
  stryMutAct_9fa48("1802") ? "" : (stryCov_9fa48("1802"), "hex-di/adapter-access")
);
 ...
 * @internal
 */
export const HOOKS_ACCESS = Symbol.for(
  stryMutAct_9fa48("1803") ? "" : (stryCov_9fa48("1803"), "hex-di/hooks-access")
);
 ...
 * ```
 */
export const INSPECTOR = Symbol.for(
  stryMutAct_9fa48("1804") ? "" : (stryCov_9fa48("1804"), "hex-di/inspector")
);
