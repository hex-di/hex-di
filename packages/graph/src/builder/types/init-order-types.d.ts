 ...
 * @internal
 */
export type HasAsyncDependency<TDepGraph, TAsyncPorts, TPort extends string> = GetDirectDeps<TDepGraph, TPort> extends infer TDeps ? TDeps extends string ? TDeps extends ExtractAsyncPortNames<TAsyncPorts> ? true : false : false : false;
/**
 * Extracts port names from async port types.
 *
 * @internal
 */
type ExtractAsyncPortNames<TAsyncPorts> = TAsyncPorts extends {
 ...
 * @internal
 */
export type Tier0Ports<TDepGraph, TAsyncPorts> = TAsyncPorts extends infer P ? P extends {
    readonly __portName: infer N extends string;
} ? HasAsyncDependency<TDepGraph, TAsyncPorts, N> extends false ? P : never : never : never;
/**
 ...
 */
export type AsyncInitSummary<B> = B extends GraphBuilderSignature<infer _TProvides, infer _TRequires, infer TAsyncPorts, infer _TOverrides, infer TInternalState extends AnyBuilderInternals> ? Prettify<{
 ...
 */
export type IsAsyncPort<B, TPort> = B extends GraphBuilderSignature<infer _TProvides, infer _TRequires, infer TAsyncPorts, infer _TOverrides, infer _TInternalState extends AnyBuilderInternals> ? TPort extends TAsyncPorts ? true : false : never;
/**
 ...
 * @typeParam B - The GraphBuilder type
 */
export type AsyncPortNames<B> = B extends GraphBuilderSignature<infer _TProvides, infer _TRequires, infer TAsyncPorts, infer _TOverrides, infer _TInternalState extends AnyBuilderInternals> ? ExtractAsyncPortNames<TAsyncPorts> : never;
/**
 ...
 * @typeParam B - The GraphBuilder type
 */
export type RequiresInitialization<B> = B extends GraphBuilderSignature<infer _TProvides, infer _TRequires, infer TAsyncPorts, infer _TOverrides, infer _TInternalState extends AnyBuilderInternals> ? IsNever<TAsyncPorts> extends true ? false : true : never;
export {};
