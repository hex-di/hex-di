 ...
 * @internal
 */
export declare const __emptyDepGraphBrand: unique symbol;
/**
 ...
 * @internal
 */
export declare const __emptyLifetimeMapBrand: unique symbol;
/**
...
out TUnsafeDepthOverride extends boolean = false, out TDepthExceededWarning extends string = never, out TUncheckedUsed extends boolean = false> {
 ...
 * @internal
 */
export type AnyBuilderInternals = BuilderInternals<object, object, unknown, number, boolean, string, boolean>;
/**
 ...
 * @internal
 */
export type WithDepGraph<T extends AnyBuilderInternals, TNewDepGraph> = BuilderInternals<TNewDepGraph, T["lifetimeMap"], T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 * Creates a new BuilderInternals with an updated lifetime map.
 *
 * @internal
 */
export type WithLifetimeMap<T extends AnyBuilderInternals, TNewLifetimeMap> = BuilderInternals<T["depGraph"], TNewLifetimeMap, T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 * Creates a new BuilderInternals with updated dependency graph and lifetime map.
 *
 * @internal
 */
export type WithDepGraphAndLifetimeMap<T extends AnyBuilderInternals, TNewDepGraph, TNewLifetimeMap> = BuilderInternals<TNewDepGraph, TNewLifetimeMap, T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 * Creates a new BuilderInternals with a specified parent provides.
 *
 * @internal
 */
export type WithParentProvides<T extends AnyBuilderInternals, TNewParentProvides> = BuilderInternals<T["depGraph"], T["lifetimeMap"], TNewParentProvides, T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 * Creates a new BuilderInternals with a specified max depth.
 *
 * @internal
 */
export type WithMaxDepth<T extends AnyBuilderInternals, TNewMaxDepth extends number> = BuilderInternals<T["depGraph"], T["lifetimeMap"], T["parentProvides"], TNewMaxDepth, T["unsafeDepthOverride"], T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 * Creates a new BuilderInternals with a specified unsafe depth override flag.
 *
 * @internal
 */
export type WithUnsafeDepthOverride<T extends AnyBuilderInternals, TNewUnsafeDepthOverride extends boolean> = BuilderInternals<T["depGraph"], T["lifetimeMap"], T["parentProvides"], T["maxDepth"], TNewUnsafeDepthOverride, T["depthExceededWarning"], T["uncheckedUsed"]>;
/**
 ...
 * @internal
 */
export type WithDepthExceededWarning<T extends AnyBuilderInternals, TNewDepthExceededWarning extends string> = BuilderInternals<T["depGraph"], T["lifetimeMap"], T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"] | TNewDepthExceededWarning, T["uncheckedUsed"]>;
/**
 ...
 * @internal
 */
export type WithUncheckedUsed<T extends AnyBuilderInternals> = BuilderInternals<T["depGraph"], T["lifetimeMap"], T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"], true>;
/**
 ...
 * @internal
 */
export type WithDepGraphLifetimeAndWarning<T extends AnyBuilderInternals, TNewDepGraph, TNewLifetimeMap, TWarningPort extends string> = BuilderInternals<TNewDepGraph, TNewLifetimeMap, T["parentProvides"], T["maxDepth"], T["unsafeDepthOverride"], T["depthExceededWarning"] | TWarningPort, T["uncheckedUsed"]>;
/**
 ...
 * @internal
 */
export type UnifiedMergeInternals<T1 extends AnyBuilderInternals, T2 extends AnyBuilderInternals, TMergedDepGraph, TMergedLifetimeMap, TResolvedMaxDepth extends number> = BuilderInternals<TMergedDepGraph, TMergedLifetimeMap, GetParentProvides<T1>, TResolvedMaxDepth, BoolOr<GetUnsafeDepthOverride<T1>, GetUnsafeDepthOverride<T2>>, GetDepthExceededWarning<T1> | GetDepthExceededWarning<T2>, BoolOr<GetUncheckedUsed<T1>, GetUncheckedUsed<T2>>>;
