 ...
 * @internal
 */
export declare function mergeGraphs(first: BuildableGraph, second: BuildableGraph): BuildableGraphState;
/**
 ...
 * @internal
 */
export declare function mergeGraphsWithOptions(first: BuildableGraph, second: BuildableGraph, _options: MergeGraphOptions): BuildableGraphState;
