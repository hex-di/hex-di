 ...
 * @internal
 */
export declare function validateBuildable(buildable: BuildableGraph): void;
/**
 ...
 * @internal
 */
export declare function buildGraph(buildable: BuildableGraph): BuiltGraph;
/**
 ...
 * @internal
 */
export declare function buildGraphFragment(buildable: BuildableGraph): BuiltGraph;
