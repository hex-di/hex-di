 ...
 * @internal
 */
type BuildTuple<TLength extends number, TAcc extends readonly unknown[] = []> = TAcc["length"] extends TLength ? TAcc : BuildTuple<TLength, [...TAcc, unknown]>;
/**
 ...
 * @internal
 */
type IsValidDepthNumber<TDepth extends number> = [TDepth] extends [0] ? false : BuildTuple<TDepth> extends infer TTuple extends readonly unknown[] ? TTuple["length"] extends TDepth ? [TDepth] extends [MaxAllowedDepth] ? true : BuildTuple<MaxAllowedDepth>["length"] extends number ? [TTuple["length"]] extends [never] ? false : TTuple extends BuildTuple<MaxAllowedDepth> ? true : BuildTuple<MaxAllowedDepth> extends [...TTuple, ...infer _Rest] ? true : false : false : false : false;
/**
 ...
 * @internal
 */
export type CompareNumbers<TFirst extends number, TSecond extends number> = TFirst extends TSecond ? "equal" : BuildTuple<TFirst> extends infer T1 extends readonly unknown[] ? BuildTuple<TSecond> extends infer T2 extends readonly unknown[] ? T2 extends [...T1, ...infer _Rest] ? _Rest["length"] extends 0 ? "equal" : "less" : "greater" : "equal" : "equal";
/**
 ...
 * @internal
 */
export type MinNumber<TFirst extends number, TSecond extends number> = CompareNumbers<TFirst, TSecond> extends "greater" ? TSecond : TFirst;
export {};
