...
export type { AdapterProvidesName, AdapterRequiresNames, ExtractRequiresStrings, } from "../adapter-extraction.js";
import type { AdapterProvidesName, AdapterRequiresNames, ExtractRequiresStrings } from "../adapter-extraction.js";
/**
 ...
 * @internal
 */
export type WouldCreateCycle<TDepGraph, TProvides extends string, TRequires extends string, TMaxDepth extends number = DefaultMaxDepth> = IsNever<TRequires> extends true ? false : IsReachable<TDepGraph, TRequires, TProvides, never, [], TMaxDepth>;
/**
 ...
 * @internal
 */
export type WouldExceedDepthLimit<TDepGraph, TFrom extends string, TDepth extends Depth = [], TMaxDepth extends number = DefaultMaxDepth> = DepthExceeded<TDepth, TMaxDepth> extends true ? true : IsNever<TFrom> extends true ? false : TFrom extends string ? GetDirectDeps<TDepGraph, TFrom> extends infer Deps ? IsNever<Deps> extends true ? false : Deps extends string ? WouldExceedDepthLimit<TDepGraph, Deps, IncrementDepth<TDepth>, TMaxDepth> : false : false : false;
