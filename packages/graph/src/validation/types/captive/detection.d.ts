...
import type { CaptiveDependencyError, ReverseCaptiveDependencyError, MalformedAdapterError, ForwardReferenceMarker } from "./errors.js";
import type { InvalidLifetimeErrorMessage } from "../error-messages.js";
import type { AdapterProvidesName, AdapterRequiresNames, ExtractRequiresStrings, IsMalformedRequires } from "../adapter-extraction.js";
/**
 ...
 * @internal
 */
type HasLifetimeInMap<TLifetimeMap, TPortName extends string> = IsNever<GetLifetimeLevel<TLifetimeMap, TPortName>> extends true ? false : true;
/**
 ...
 */
export type DebugCaptiveCheck<TLifetimeMap, TDependentLevel extends number, TRequiredPortName extends string> = Prettify<{
    ...
    readonly isCaptive: GetLifetimeLevel<TLifetimeMap, TRequiredPortName> extends infer DepLevel ? IsNever<DepLevel> extends true ? false : DepLevel extends number ? IsCaptiveDependency<TDependentLevel, DepLevel> : false : false;
    /** Human-readable lifetime names for easier debugging */
    readonly dependentLifetimeName: LifetimeName<TDependentLevel>;
    readonly requiredLifetimeName: GetLifetimeLevel<TLifetimeMap, TRequiredPortName> extends infer DepLevel ? IsNever<DepLevel> extends true ? "unknown (not in map)" : DepLevel extends number ? LifetimeName<DepLevel> : "invalid" : "invalid";
}>;
/**
 ...
 * @internal
 */
type AdapterLifetimeForMap<TAdapter> = TAdapter extends {
    factoryKind: "async";
 ...
 * @internal
 */
export type AddManyLifetimes<TLifetimeMap, TAdapters extends readonly unknown[]> = TAdapters extends readonly [infer First, ...infer Rest] ? AddManyLifetimes<AddLifetime<TLifetimeMap, AdapterProvidesName<First>, AdapterLifetimeForMap<First>>, Rest> : TLifetimeMap;
/**
 ...
 * @internal
 */
type ValidateAllAgainstMap<TLifetimeMap, TAdapters extends readonly unknown[]> = TAdapters extends readonly [infer First, ...infer Rest] ? IsNever<LifetimeLevel<AdapterLifetimeForMap<First>>> extends true ? MalformedAdapterError : IsMalformedRequires<AdapterRequiresNames<First>> extends true ? MalformedAdapterError : FindAnyCaptiveDependency<TLifetimeMap, LifetimeLevel<AdapterLifetimeForMap<First>>, ExtractRequiresStrings<AdapterRequiresNames<First>>> extends infer CaptivePort ? IsNever<CaptivePort> extends true ? ValidateAllAgainstMap<TLifetimeMap, Rest> : CaptivePort extends string ? CaptiveDependencyError<AdapterProvidesName<First>, LifetimeName<LifetimeLevel<AdapterLifetimeForMap<First>>>, CaptivePort, LifetimeName<GetLifetimeLevel<TLifetimeMap, CaptivePort>>> : MalformedAdapterError : MalformedAdapterError : false;
/**
