 ...
 */
export type MalformedAdapterReason = "missing-requires" | "invalid-lifetime" | "invalid-requires" | "inference-failed" | "unknown";
/**
 ...
 * ```
 */
export type IsMalformedAdapterError<T> = [
    T
] extends [never] ? false : T extends MalformedAdapterError<string> ? true : false;
/**
 ...
 * ```
 */
export type IsForwardReference<T> = [
    T
] extends [never] ? false : T extends ForwardReferenceMarker<string> ? true : false;
export {};
