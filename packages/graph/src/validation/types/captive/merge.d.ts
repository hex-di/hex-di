 ...
 * @internal
 */
type BuildCaptiveError<TLifetimeMap, TPort extends string, TLevel extends number, TCaptive extends string> = CaptiveDependencyError<TPort, LifetimeName<TLevel>, TCaptive, LifetimeName<GetLifetimeLevel<TLifetimeMap, TCaptive>>>;
/**
 ...
 * @internal
 */
type CheckPortForCaptive<TDepGraph, TLifetimeMap, TPort extends string> = GetLifetimeLevel<TLifetimeMap, TPort> extends infer Level ? Level extends number ? CheckDepsForCaptive<TDepGraph, TLifetimeMap, TPort, Level> : never : never;
/**
 ...
 * @internal
 */
type CheckEachKeyForCaptive<TDepGraph, TLifetimeMap, TKey extends string> = TKey extends string ? CheckPortForCaptive<TDepGraph, TLifetimeMap, TKey> : never;
/**
