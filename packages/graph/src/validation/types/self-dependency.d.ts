...
] extends [never] ? false : AdapterProvidesName<TAdapter> extends AdapterRequiresNames<TAdapter> ? true : false;
/**
 ...
 * @internal
 */
export type HasSelfDependencyInBatch<TAdapters extends readonly unknown[]> = TAdapters extends readonly [infer First, ...infer Rest extends readonly unknown[]] ? HasSelfDependency<First> extends true ? true : HasSelfDependencyInBatch<Rest> : false;
/**
 ...
 * @internal
 */
export type FindSelfDependencyPort<TAdapters extends readonly unknown[]> = TAdapters extends readonly [infer First, ...infer Rest extends readonly unknown[]] ? HasSelfDependency<First> extends true ? AdapterProvidesName<First> : FindSelfDependencyPort<Rest> : never;
