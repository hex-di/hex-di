 ...
 * ```
 */
export type DebugInferGraphProvides<TGraph> = TGraph extends {
    __provides: infer TProvides;
} ? {
    readonly extracted: TProvides;
    readonly sourceType: "phantom";
} : TGraph extends Graph<infer TProvides, infer _TAsync, infer _TOverrides> ? {
    readonly extracted: TProvides;
    readonly sourceType: "Graph";
} : {
    readonly extracted: never;
 ...
 * ```
 */
export type DebugInferGraphRequires<TGraph> = TGraph extends {
    __requires: infer TRequires;
} ? {
    readonly extracted: TRequires;
    readonly sourceType: "phantom";
} : {
    readonly extracted: never;
    readonly sourceType: "notGraphBuilder";
};
/**
 ...
 * ```
 */
export type DebugInferGraphAsyncPorts<TGraph> = TGraph extends {
    __asyncPorts: infer TAsync;
} ? {
    readonly extracted: TAsync;
    readonly sourceType: "phantom";
 ...
 * ```
 */
export type DebugInferGraphOverrides<TGraph> = TGraph extends {
    __overrides: infer TOverrides;
} ? {
    readonly extracted: TOverrides;
    readonly sourceType: "phantom";
