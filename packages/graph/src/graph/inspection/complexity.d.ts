...
export declare const INSPECTION_CONFIG: {
     ...
     */
    readonly DEPTH_WARNING_THRESHOLD: 40;
    /**
 ...
 * ```
 */
export declare function computeTypeComplexity(adapterCount: number, maxDepth: number, dependencyMap: Record<string, readonly string[]>): ComplexityBreakdown;
/**
 ...
 * @internal
 */
export declare function computeTypeComplexityScore(adapterCount: number, maxDepth: number, dependencyMap: Record<string, readonly string[]>): number;
/**
 ...
 * @internal
 */
export declare function getPerformanceRecommendation(score: number): "safe" | "monitor" | "consider-splitting";
