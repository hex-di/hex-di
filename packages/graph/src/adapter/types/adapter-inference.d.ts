...
import type { Adapter, Lifetime, FactoryKind } from "./adapter-types.js";
 ...
 * @internal
 */
export type InferAdapterProvides<TAdapter> = TAdapter extends Adapter<infer TProvides, InferPlaceholder, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TProvides : never;
/**
 ...
 * @internal
 */
export type InferManyProvides<TAdapters> = TAdapters extends readonly (infer TElement)[] ? TElement extends Adapter<infer TProvides, InferPlaceholder, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TProvides : never : never;
/**
 ...
 * @internal
 */
export type InferManyAsyncPorts<TAdapters> = TAdapters extends readonly (infer TElement)[] ? TElement extends Adapter<infer TProvides, InferPlaceholder, LifetimePlaceholder, "async", ClonablePlaceholder> ? TProvides : never : never;
/**
 ...
 * @internal
 */
export type DebugInferAdapterProvides<TAdapter> = TAdapter extends Adapter<infer TProvides, InferPlaceholder, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TProvides : InferenceError<"InferAdapterProvides", "Input is not a valid Adapter type. Expected Adapter<TProvides, TRequires, TLifetime, TFactoryKind, TClonable>.", TAdapter>;
/**
 ...
 * @internal
 */
export type DebugInferAdapterRequires<TAdapter> = TAdapter extends Adapter<InferPlaceholder, infer TRequires, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TRequires : InferenceError<"InferAdapterRequires", "Input is not a valid Adapter type. Expected Adapter<TProvides, TRequires, TLifetime, TFactoryKind, TClonable>.", TAdapter>;
/**
 ...
 * @internal
 */
export type DebugInferAdapterLifetime<TAdapter> = TAdapter extends Adapter<InferPlaceholder, InferPlaceholder, infer TLifetime, FactoryKindPlaceholder, ClonablePlaceholder> ? TLifetime : InferenceError<"InferAdapterLifetime", "Input is not a valid Adapter type. Expected Adapter<TProvides, TRequires, TLifetime, TFactoryKind, TClonable>.", TAdapter>;
/**
 ...
 * @internal
 */
export type DebugInferManyProvides<TAdapters> = TAdapters extends readonly (infer TElement)[] ? TElement extends Adapter<infer TProvides, InferPlaceholder, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TProvides : InferenceError<"InferManyProvides", "Array element is not a valid Adapter type.", TElement> : InferenceError<"InferManyProvides", "Input is not a readonly array. Expected readonly Adapter[].", TAdapters>;
/**
 ...
 * @internal
 */
export type DebugInferManyRequires<TAdapters> = TAdapters extends readonly (infer TElement)[] ? TElement extends Adapter<InferPlaceholder, infer TRequires, LifetimePlaceholder, FactoryKindPlaceholder, ClonablePlaceholder> ? TRequires : InferenceError<"InferManyRequires", "Array element is not a valid Adapter type.", TElement> : InferenceError<"InferManyRequires", "Input is not a readonly array. Expected readonly Adapter[].", TAdapters>;
export {};
