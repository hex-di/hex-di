...
const FLOW_STATE_CLASSES: Record<FormFlowState, string> = {
  idle: "bg-gray-100 text-gray-600",
  step1: "bg-gray-100 text-gray-600",
  step2: "bg-gray-100 text-gray-600",
  step3: "bg-gray-100 text-gray-600",
...
function FlowStateIndicator({ flowState }: { readonly flowState: FormFlowState }) {
  return (
    <span
      data-testid="form-state-indicator"
      className={`text-xs px-2 py-1 rounded-full ${FLOW_STATE_CLASSES[flowState]}`}
    >
      {flowState}
    </span>
  );
...
function SubmitButtonContent({ flowState }: { readonly flowState: FormFlowState }) {
...
export function TaskCreationForm({ onSuccess, onCancel, initialData }: TaskCreationFormProps) {
  ...
  const isCurrentStepValid = React.useMemo(
    () => getStepValidity(currentStep, step1Valid, step2Valid, step3Valid),
  ...
  const isActionable = isCurrentStepValid && !isSubmitting;
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <FlowStateIndicator flowState={flowState} />
          ...
          {currentStep < 3 ? (
            ...
            <button
              ...
              `}
            >
              <SubmitButtonContent flowState={flowState} />
            </button>
          )}
        </div>
      </div>
