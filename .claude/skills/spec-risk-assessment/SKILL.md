...
3. **Invariant linkage** — Every failure mode links to the invariant it targets.
4. **High-risk test requirement** — Every High-risk invariant needs a dedicated test.
5. **Low-risk justification** — Every Low-risk classification needs an explicit prose justification.
6. **Compensating controls** — Residual risks must have compensating controls documented.
