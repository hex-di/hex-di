    ...
    <main class="relative z-10">
      <section class="min-h-screen flex items-center pt-20 relative overflow-hidden">
        ...
        <div
          ...
          style="background: linear-gradient(45deg, transparent 25%, rgba(0,240,255,0.06) 50%, transparent 75%); background-size: 200% 100%; animation: holo-slide 3s ease-in-out infinite;"
        ></div>
        <!-- 6s scanline -->
