  ...
  <body class="bg-hex-bg bg-grid overflow-x-hidden">
    ...
    <main class="relative z-10">
      <section class="min-h-screen flex items-center pt-20 relative overflow-hidden">
        ...
        <div
          class="absolute inset-0 bg-holo-shimmer animate-holo-slide bg-[length:200%_100%] opacity-50 pointer-events-none"
        ></div>
      ...
      <section class="py-24 relative overflow-hidden">
        ...
        <div
          class="absolute inset-0 bg-holo-shimmer animate-holo-slide bg-[length:200%_100%] opacity-20 pointer-events-none"
        ></div>
