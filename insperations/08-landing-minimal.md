...
<body class="bg-hex-bg bg-grid overflow-x-hidden">
  ...
  <main class="relative z-10">
    ...
    <section class="py-16"><div class="max-w-7xl mx-auto px-10">
      <div class="grid md:grid-cols-3 gap-4"><!-- 6× compact hud-card p-4 features --></div>
    </div></section>
    <section class="py-16"><div class="max-w-7xl mx-auto px-10"><!-- Terminal --></div></section>
    <section class="py-16"><div class="max-w-7xl mx-auto px-10"><!-- Architecture --></div></section>
    <section class="py-16"><div class="max-w-7xl mx-auto px-10">
    ...
    <section class="py-16"><div class="max-w-7xl mx-auto px-10"><!-- CTA --></div></section>
