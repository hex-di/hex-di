...
<body class="bg-hex-bg overflow-x-hidden" style="background-size: 160px 160px;">
  <div class="fixed inset-0 opacity-30 pointer-events-none z-0"
       style="background-size: 160px 160px; background-image: linear-gradient(to right, rgba(0,240,255,0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,240,255,0.05) 1px, transparent 1px);"></div>
  ...
  <main class="relative z-10">
    ...
    <section class="py-24 relative overflow-hidden"><div class="scanline pointer-events-none"></div>
