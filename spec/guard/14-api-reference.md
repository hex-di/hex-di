...
/**
 * A map of action names to Permission tokens, created by createPermissionGroup.
 *
 * @example
 * ```typescript
 * const UserPerms = createPermissionGroup("user", ["read", "write", "delete"]);
 * // typeof UserPerms: PermissionGroupMap<"user", { read: {}; write: {}; delete: {} }>
 ...
 *
 * See section 62 (17-gxp-compliance/03-clock-synchronization.md) for guard-specific
 ...
 * and NTP-synchronized timestamps. See 17-gxp-compliance/02-audit-trail-contract.md section 61.
 */
