...
// Verify all 13 items pass (no FAIL results)
...
const oq = await runOQ(guardGraph); // OQ-1 through OQ-42
const pq = await runPQ(guardGraph); // PQ-1 through PQ-9 (4-hour soak)
```
