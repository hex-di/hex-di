...
| Change History   | 1.3 (2026-02-13): Added OQ-38 through OQ-42 (predicate rule mapping, certificate chain, algorithm migration, policy input schema, attribute accuracy) |
...
> across all 21 DoD items is 707. (HTTP transport tests — formerly DoD 20-22
> with 105 tests — were moved to the http-client spec in v0.1.1.)
