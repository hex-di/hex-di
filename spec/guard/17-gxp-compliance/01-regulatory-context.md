...
- **Test evidence:** The Definition of Done (section 16) specifies 713 tests across 21 verification items, including type-level tests, unit tests, and integration tests.
