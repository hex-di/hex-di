...
| `catchTag(tag, handler)`   | Function | `fn/catch-tag.ts`     |
| `catchTags(handlers)`      | Function | `fn/catch-tags.ts`    |
| `andThenWith(onOk, onErr)` | Function | `fn/and-then-with.ts` |
...
| `TaggedError<Tag, Fields?>`  | Type alias | `type-utils.ts` |
| `TagsOf<E>`                  | Type alias | `type-utils.ts` |
| `HasTag<E, Tag>`             | Type alias | `type-utils.ts` |
| `ErrorByTag<E, Tag>`         | Type alias | `type-utils.ts` |
| `RemoveTag<E, Tag>`          | Type alias | `type-utils.ts` |
| `RemoveTags<E, Tags>`        | Type alias | `type-utils.ts` |
| `ExhaustiveHandlerMap<E, T>` | Type alias | `type-utils.ts` |
...
| `fn/catch-tag.ts`                  | `catchTag(tag, handler)` — standalone curried function         |
| `fn/catch-tags.ts`                 | `catchTags(handlers)` — standalone curried function            |
| `fn/and-then-with.ts`              | `andThenWith(onOk, onErr)` — standalone curried function       |
