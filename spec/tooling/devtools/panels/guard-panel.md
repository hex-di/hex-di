...
The policy tree uses the same indented tree layout as the scope tree in the Scopes Panel (spec/tooling/devtools/05-visual-design.md Section 14.6). Each node renders:
...
The Guard Panel follows the design token system from spec/tooling/devtools/05-visual-design.md Section 13. Guard-specific color usage:
