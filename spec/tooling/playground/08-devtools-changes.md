...
This addendum documents all changes required to the existing DevTools specification (`spec/tooling/devtools/`) to support the shared infrastructure model. These changes are a prerequisite for both the playground and the refactored devtools dashboard.
