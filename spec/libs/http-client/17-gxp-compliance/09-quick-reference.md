...
_Previous: [22 - GxP Compliance Audit v5.0 Remediations](./22-gxp-compliance-audit-v5.md) | Next: [24 - Regulatory Traceability Matrix](./24-traceability-matrix.md)_
...
> **Cross-reference:** Full classification scheme with criteria, escalation rules, and endpoint registry guidance in [18a - HTTPS & TLS Enforcement §84](./18a-https-tls-enforcement.md#gxp-endpoint-data-classification).
...
> **Cross-reference:** The port dependency inventory in §118 ([22 - GxP Compliance Audit v5.0](./22-gxp-compliance-audit-v5.md)) lists the 14 port interfaces that GxP features depend on. This table extends that inventory with additional runtime ports and lifetime/requirement metadata for deployment planning.
