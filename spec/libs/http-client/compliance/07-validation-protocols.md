# GxP Compliance — @hex-di/http-client: Validation Protocols (FMEA, IQ/OQ/PQ, RTM)
...
> For the generic FMEA methodology, see [../../../cross-cutting/gxp/05-fmea-methodology.md](../../../cross-cutting/gxp/05-fmea-methodology.md). This section covers HTTP-specific transport validation and failure modes.
...
> **Standalone copy available:** For auditor access and independent version control, this traceability matrix is also available as a standalone document at [10 — Reference Materials](./10-reference-materials.md). That file is the authoritative copy.

This section maps GxP findings from the HTTP client compliance reviews to regulations, spec sections, DoD items, and test references. The authoritative and complete traceability matrix (62 findings, v8.0) is maintained in [10 — Reference Materials](./10-reference-materials.md). This section contains the §100 cross-reference and REQUIREMENT block.
...
> **Note:** DoD 26 details (§108-118) are in [09 — Advanced Requirements](./09-advanced-requirements.md). DoD 27 details are also in that document. Grand total across all sources: **272 (core §1-78, including 22 E2E) + 40 (transport adapters §44a-§44d) + 450 (GxP DoDs 20-27) + 18 (chaos/load/soak) = 780 tests**.
