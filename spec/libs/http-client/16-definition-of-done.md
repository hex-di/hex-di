...
### Fetch Adapter Tests (`@hex-di/http-client-fetch`)
...
### Axios Adapter Tests (`@hex-di/http-client-axios`)
...
### Got Adapter Tests (`@hex-di/http-client-got`)
...
### Ky Adapter Tests (`@hex-di/http-client-ky`)
...
### Ofetch Adapter Tests (`@hex-di/http-client-ofetch`)
...
This section provides a traceable mapping between the Definition of Done (DoD) test IDs defined above and the corresponding Operational Qualification (OQ) test IDs in §99b ([20 - HTTP Transport Validation](./20-http-transport-validation.md)). This mapping enables auditors to trace from unit/integration test evidence to qualification protocol evidence.
...
> **Note:** OQ check IDs reference the authoritative qualification protocol in §99b of [20 - HTTP Transport Validation](./20-http-transport-validation.md). Deployment-specific adjustments to test execution order are governed by the Validation Plan (§25) approval process but MUST NOT change the functional scope of each OQ check.
...
- [ ] All 29 files exist under `spec/http-client/` (README.md + 00-urs.md + 01-15 + 16-definition-of-done.md + 17-gxp-compliance.md + 18a/18b/18c + 19 + 20 + 21 + 22 + 23 + 24-traceability-matrix.md + 25-validation-plan.md)
...
**Section:** [18a](./18a-https-tls-enforcement.md)/[18b](./18b-payload-credential-security.md)/[18c](./18c-session-auth-extended.md) - HTTP Transport Security (§84-§90d)
...
**Section:** [17 - GxP Compliance Guide](./17-gxp-compliance.md) (§79-§83c)
...
> **Note:** Tests for this DoD section are enumerated in the OQ checklist (§99b). Findings #21, #22, #28 in the [traceability matrix](./24-traceability-matrix.md) reference DoD 23 as the verification domain. Test IDs ESB-001 through ESB-015, VP-001 through VP-005, and PR-001 through PR-008 provide the evidence base.

## DoD 24: GxP Compliance Extensions

**Section:** [21 - GxP Compliance Extensions](./21-gxp-compliance-extensions.md) (§104-§107)
...
> **Note:** Tests for this DoD section are enumerated in the OQ checklist (§99b). Findings #29-#32 in the [traceability matrix](./24-traceability-matrix.md) reference DoD 24. Test IDs RET-001 through RET-010, QRY-001 through QRY-012, REV-001 through REV-010, and SIG-001 through SIG-014 provide the evidence base. Data-at-rest encryption tests are an extension of this DoD section.

## DoD 25: GxP Compliance Audit v4.0 Remediations

**Section:** [18a](./18a-https-tls-enforcement.md)/[18b](./18b-payload-credential-security.md)/[18c](./18c-session-auth-extended.md)/[19](./19-http-audit-bridge.md)/[20](./20-http-transport-validation.md) (§84-§103, extensions from findings #33-#52)
...
> **Note:** Tests for this DoD section are enumerated in the OQ checklist (§99b). Findings #33-#52 in the [traceability matrix](./24-traceability-matrix.md) reference DoD 25.

## DoD 26: GxP Compliance Audit v5.0 Remediations

**Section:** [22 - GxP Compliance Audit v5.0 Remediations](./22-gxp-compliance-audit-v5.md) (§108-§118)
...
> **Note:** Tests for this DoD section are enumerated in the OQ checklist (§99b). Findings #53-#57 in the [traceability matrix](./24-traceability-matrix.md) reference DoD 27. Test IDs RFR-001 through RFR-006, DDG-001 through DDG-004, ARC-001 through ARC-010, and SCT-001 through SCT-004 provide the evidence base.
