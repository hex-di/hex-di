...
### Transport Adapter Packages

| Package                         | Export                     | Factory                                                    | Adapter                                                   |
| ------------------------------- | -------------------------- | ---------------------------------------------------------- | --------------------------------------------------------- |
| `@hex-di/http-client-fetch`     | `FetchHttpClientAdapter`   | `createFetchHttpClient(options?)`                          | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-axios`     | `AxiosHttpClientAdapter`   | `createAxiosHttpClient(options?)`                          | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-got`       | `GotHttpClientAdapter`     | `createGotHttpClient(options?)`                            | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-ky`        | `KyHttpClientAdapter`      | `createKyHttpClient(options?)`                             | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-ofetch`    | `OfetchHttpClientAdapter`  | `createOfetchHttpClient(options?)`                         | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-node`      | `NodeHttpClientAdapter`    | `createNodeHttpClient(options?)`                           | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-undici`    | `UndiciHttpClientAdapter`  | `createUndiciHttpClient(options?)`                         | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
| `@hex-di/http-client-bun`       | `BunHttpClientAdapter`     | `createBunHttpClient(options?)`                            | `Adapter<typeof HttpClientPort, [], "singleton", "sync">` |
