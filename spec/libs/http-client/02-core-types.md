...
1. **Type safety** -- transport adapters can pattern-match on `_tag` to serialize correctly without guessing
...
> **Tests**: [Core Types Tests (CT-001–CT-017)](./17-definition-of-done.md#core-types-tests)
