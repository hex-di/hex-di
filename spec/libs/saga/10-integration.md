...
> **Canonical source:** For complete integration patterns, code examples, and wiring guides, see [Integration: Flow + Saga](../../cross-cutting/integration/flow-saga.md). This section provides a summary and the shared contract types.
