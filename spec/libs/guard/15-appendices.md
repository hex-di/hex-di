...
> | Change History   | 2.2 (2026-02-20): Auditor presentation Step 7: updated failure mode count 31 → 36 (CCR-GUARD-045) |
> |                  | 2.1 (2026-02-20): Updated nav footer links api-reference.md → 14-api-reference.md (CCR-GUARD-043) |
> |                  | 2.0 (2026-02-20): Converted document control to blockquote format; fixed nav footer links (14-api-reference.md → api-reference.md) to resolve duplicate Document ID (CCR-GUARD-042) |
...
- FMEA showing all 36 failure modes mitigated (FM-01–31 in §68 / 10-risk-assessment.md; FM-32–36 in risk-assessment.md)
...
| ---- | -------------------------- | ------------------------------------------------------------------------- | -------------- | --------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ------------ |
| S-01 | **S**poofing               | Forge AuthSubject identity by registering a rogue SubjectProvider adapter | TB-1, TB-2     | TA-1, TA-2      | FM-08        | ADR #9 (immutable subject per scope); audit trail records subject attributes (ALCOA+ Attributable); security test §56.3 scenario 7                                                          | Low           | Low          |
| S-02 | **S**poofing               | Replay a valid ReauthenticationToken to forge electronic signatures       | TB-3           | TA-2, TA-3      | FM-06        | Token expiration (§65b, 15-min max lifetime ADR #39); one-time-use tokens; security test §56.2 scenario 4                                                                                   | Low           | Low          |
...
| E-01 | **E**levation of Privilege | Bypass guard() via direct port resolution                                 | TB-1, TB-2     | TA-1            | FM-12        | Guard wraps at adapter level (ADR #8); port gate hook intercepts resolution; security test §56.3 scenario 9                                                                                 | Low           | Low          |
