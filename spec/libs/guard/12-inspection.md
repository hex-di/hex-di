 ...
 * authorization evaluation events. Adapters consuming it (via requires) can
 * subscribe to guard events and read inspection snapshots.
 *
 * The GuardLibraryInspectorAdapter consumes this port to bridge the GuardInspector
 * to the container's unified inspection system.
 *
