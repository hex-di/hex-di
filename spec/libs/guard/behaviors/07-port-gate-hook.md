...
_Previous: [07 - Guard Adapter](./06-guard-adapter.md)_

---

## BEH-GD-030: createPortGateHook (§29)

> **DoD:** [DoD 17: Port Gate Hook](../16-definition-of-done.md#dod-17-port-gate-hook)
...
## BEH-GD-031: Coarse vs Fine-Grained Enforcement (§30)
...
>
> For GxP-regulated ports, always use `guard()` as the primary authorization mechanism. See 07-guard-adapter.md section 25 for the full guard contract and ../compliance/gxp.md for compliance requirements.
...
> **Related Controls:** For rate limiting of guard evaluations (which applies at the `guard()` wrapper level, not the port gate hook level), see section 27d in [07 - Guard Adapter](./06-guard-adapter.md). Rate limiting applies to fine-grained `guard()` evaluations and produces `RateLimitSummaryAuditEntry` records in the audit trail.

---

_Next: [09 - Serialization](./08-serialization.md)_
