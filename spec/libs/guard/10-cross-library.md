...
> **SUPERSEDED** — This file is the original numbered-chapter version. The canonical specification is now in [`behaviors/09-cross-library.md`](./behaviors/09-cross-library.md) (GUARD-10, rev 2.1). This file is retained for reference only.

<!-- Document Control
| Property         | Value                                    |
|------------------|------------------------------------------|
| Document ID      | GUARD-10-LEGACY                          |
| Revision         | 1.0                                      |
| Effective Date   | 2026-02-13                               |
| Status           | Superseded by behaviors/09-cross-library.md |
| Author           | HexDI Engineering                        |
| Reviewer         | GxP Compliance Review                    |
| Approved By      | Technical Lead, Quality Assurance Manager |
| Classification   | GxP Functional Specification (Superseded) |
| Change History   | 1.0 (2026-02-13): Initial controlled release — superseded by behaviors/09-cross-library.md per CCR-GUARD-023 |
-->
