...
- [ ] No inspection-specific adapters or `hexdi://` URIs in spec/mcp/ framework code (those belong in spec/devtools/)
...
- [ ] vision/phase-4 Section 4.2 references spec/mcp/ and notes inspection adapters in devtools
- [ ] DevTools spec files reference spec/mcp/ for the MCP framework layer
