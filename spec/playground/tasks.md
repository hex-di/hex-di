...
**Reference:** `spec/devtools/05-visual-design.md` for token values
...
**Spec:** `02-shared-infrastructure.md` Section 7.3, `spec/devtools/04-panels.md`
