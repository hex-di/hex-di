# Requirements Archive: v5.0 Runtime Package Improvements
...
- [x] **QUAL-01**: Extract shared wrapper logic to `wrapper-utils.ts` (~200 LOC reduction)
- [x] **QUAL-02**: Split `types.ts` (1,271 lines) into 6 files (<400 lines each)
- [x] **QUAL-03**: Consolidate inspection code into core runtime (remove plugin indirection)
- [x] **QUAL-04**: Consolidate tracing code into core runtime (remove plugin indirection)
- [x] **QUAL-05**: Add explicit return types to internal functions
- [x] **QUAL-06**: Remove HOOKS_ACCESS plugin system (tracing/inspection are core features)
...
- [x] **API-05**: Remove legacy type exports (`CaptiveDependencyErrorLegacy`, etc.)
...
**Shipped:** 26 of 27 v5.0 requirements
**Adjusted:** None
**Dropped:** API-04 (backward compatible overload) — removed per project policy of clean breaks over deprecation

---

_Archived: 2026-02-05 as part of v5.0 milestone completion_
