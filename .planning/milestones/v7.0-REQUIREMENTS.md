...
- [x] **PERF-01**: NoOp tracer overhead < 5% vs no tracing (achieved: 0% via conditional hook registration)
- [x] **PERF-02**: Memory tracer overhead < 10% vs no tracing (achieved: ~212% / 3.12x, acceptable for dev/test use case)
