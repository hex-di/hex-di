  ...
  return (
    <Section id="problem" number={2} label="The Problem" title="Authorization is broken">
      <p className="text-hex-muted text-lg leading-relaxed mb-8 max-w-4xl">
        Most apps scatter authorization across three disconnected silos. Identity lives in the auth
        provider, permissions hide in feature flags and ad-hoc checks, and enforcement is
      ...
      <HudCard>
        ...
        <p className="font-mono text-base text-hex-muted leading-relaxed">
          <span className="text-hex-primary">@hex-di/guard</span> unifies identity, permissions, and
          enforcement into a single type-safe, testable, auditable system. Permissions are branded
          tokens. Roles form a DAG. Policies compose with combinators. Enforcement happens through
          the DI graph.
        </p>
      </HudCard>
    </Section>
