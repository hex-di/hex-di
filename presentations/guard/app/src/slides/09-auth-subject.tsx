  ...
  return (
    <Section id="auth-subject" number={9} label="Enforcement" title="Auth Subject">
      <p className="text-hex-muted text-lg leading-relaxed mb-8 max-w-4xl">
        ...
        identity that policies evaluate against. It carries the user's ID, role assignments, granted
        permissions, and arbitrary attributes for ABAC. Created via{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        <CodeBlock title="AuthSubject interface">
          ...
          {"\n"}
          {"  "}
          <span className="syn-keyword">readonly</span> <span className="syn-property">roles</span>:{" "}
          ...
          {"  "}
          <span className="syn-keyword">readonly</span>{" "}
          <span className="syn-property">attributes</span>: <span className="syn-type">Record</span>
          {"<"}
