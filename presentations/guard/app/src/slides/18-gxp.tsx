  ...
  return (
    <Section id="gxp" number={18} label="Production & Beyond" title="GxP Compliance">
      <p className="text-hex-muted text-lg leading-relaxed mb-4 max-w-4xl">
        Guard is built for <span className="text-hex-amber">regulated environments</span>. The audit
        trail, electronic signatures, write-ahead log, and data retention modules satisfy FDA 21 CFR
        Part 11 and EU GMP Annex 11 requirements.
      </p>
