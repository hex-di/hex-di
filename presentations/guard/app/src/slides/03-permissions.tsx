    ...
    <Section id="permissions" number={3} label="Foundations" title="Permission Tokens">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        <CodeBlock title="creating permissions">
          ...
          {"\n"}
          {"\n"}
          <span className="syn-keyword">const</span> <span className="syn-property">writeDoc</span>{" "}
          = <span className="syn-function">createPermission</span>({"\n"}
          {"  "}
          <span className="syn-property">resource</span>:{" "}
          <span className="syn-string">'document'</span>,{"\n"}
          {"  "}
          <span className="syn-property">action</span>: <span className="syn-string">'write'</span>
          {"\n"}
          {")"}
          {"\n"}
          {"\n"}
        ...
        <CodeBlock title="type safety">
          ...
          {"<"}
          <span className="syn-string">'document'</span>, <span className="syn-string">'read'</span>
          {">"}
          {"\n"}
          {")"} {"{"}
          {"\n"}
          ...
          {"\n"}
          <span className="syn-function">checkRead</span>(
          <span className="syn-property">readDoc</span>) <span className="syn-comment">// OK</span>
          {"\n"}
          <span className="syn-function">checkRead</span>(
          ...
          {"\n"}
          <span className="syn-function">checkRead</span>(<span className="syn-property">fake</span>
          ) <span className="syn-comment">// Type Error!</span>
        </CodeBlock>
      </div>
      ...
      <HudCard>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-base text-hex-muted">
          ...
          <div>
            ...
            Because the runtime representation is a string, permissions serialize naturally to JSON,
            JWT claims, and database columns.
          </div>
        </div>
      </HudCard>
    </Section>
