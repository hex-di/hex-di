...
const INSTALL_CMD = "npm install @hex-di/clock";
const ACCENT = "#F92672";
...
const FEATURES: Feature[] = [
  ...
  {
    title: "Frozen Clock",
    description: "Pin time to a specific instant for deterministic snapshot testing.",
  },
  {
    title: "Virtual Advance",
    description:
      "Advance time programmatically. Test timeouts, debounces, and scheduling without waiting.",
  },
  {
    title: "Port-Based",
    description: "Clock is a port. Production uses real time, tests use fake time. Same interface.",
  },
  {
    title: "Timer Support",
    description:
  ...
  },
  {
    ...
    description: "Type-safe duration arithmetic. No more raw millisecond math.",
  },
];
  ...
  return (
    <section className="hero-section">
      ...
      >
        ...
        >
          Time Abstraction for TypeScript
        </p>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Clock integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Time Abstraction for TypeScript">
      <Head>
        <title>Clock | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
