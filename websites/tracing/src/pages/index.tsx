...
const INSTALL_CMD = "npm install @hex-di/tracing";
const ACCENT = "#00F0FF";
...
const FEATURES: Feature[] = [
  {
    ...
    description: "Export spans to Jaeger, Zipkin, Datadog, or any OTel-compatible backend.",
  },
  {
  ...
  },
  {
    ...
    description: "Trace context flows through DI resolution, async boundaries, and HTTP calls.",
  },
  {
    title: "Span Attributes",
    description: "Type-safe span attributes with semantic conventions. No string-based guesswork.",
  },
  {
    title: "Sampling",
    description: "Head-based and tail-based sampling strategies. Control trace volume precisely.",
  },
  {
    title: "Test Support",
    description: "In-memory span collector for assertions. Verify tracing behavior in tests.",
  },
];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Tracing integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Distributed Tracing for TypeScript">
      <Head>
        <title>Tracing | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
