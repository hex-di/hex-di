...
const INSTALL_CMD = "npm install @hex-di/logger";
const ACCENT = "#A6E22E";
...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: "Console, file, HTTP, and custom transports. Route logs to any destination.",
  },
  {
    title: "Log Levels",
    description: "Trace, debug, info, warn, error, fatal. Filter by level per transport.",
  },
  {
  ...
  {
    title: "Child Loggers",
    description: "Create scoped child loggers that inherit parent context and add their own.",
  },
];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Logger integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Structured Logging for TypeScript">
      <Head>
        <title>Logger | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
