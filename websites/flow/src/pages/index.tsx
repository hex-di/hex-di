...
const INSTALL_CMD = "npm install @hex-di/flow";
const ACCENT = "#AB47BC";
...
const FEATURES: Feature[] = [
  {
    title: "Compile-Time Transitions",
    description:
  ...
  },
  {
    ...
    description: "Inspect machine state, history, and transitions with the HexDI devtools.",
  },
];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Flow integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Type-Safe State Machines for TypeScript">
      <Head>
        <title>Flow | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
