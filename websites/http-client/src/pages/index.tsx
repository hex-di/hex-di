...
const INSTALL_CMD = "npm install @hex-di/http-client";
const ACCENT = "#5FFFFF";
...
const FEATURES: Feature[] = [
  {
    ...
    description: "Request and response types are validated at compile time. No runtime surprises.",
  },
  {
    title: "Interceptors",
    description:
  ...
  },
  {
    ...
    description: "Configurable retry with exponential backoff, jitter, and circuit breaking.",
  },
  {
    title: "Port-Based",
    description:
  ...
  },
  {
    ...
    description: "Identical in-flight requests are merged. Save bandwidth and reduce server load.",
  },
  {
    title: "Timeout Management",
    description: "Per-request and global timeouts with abort controller integration.",
  },
];
    ...
    <section style={{ padding: "100px 40px", background: "#08101C" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <FadeIn>
          ...
          <h2 style={S.h2()}>Why HTTP Client?</h2>
        </FadeIn>
        <div
          style={{
            display: "grid",
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            HTTP Client integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Type-Safe HTTP Client for TypeScript">
      <Head>
        <title>HTTP Client | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
