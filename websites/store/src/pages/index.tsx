...
const INSTALL_CMD = "npm install @hex-di/store";
const ACCENT = "#26A69A";
...
const FEATURES: Feature[] = [
  ...
  {
    title: "Selectors",
    description: "Derived state with memoized selectors. Compose complex state from simple atoms.",
  },
  {
    title: "Middleware",
    description:
  ...
  {
    title: "DI-Aware",
    description: "Stores are ports. Inject dependencies and swap implementations for testing.",
  },
  {
    title: "Devtools",
    description:
  ...
  },
  {
    ...
    description: "Structural sharing with frozen state objects. No accidental mutations.",
  },
];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Store integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Type-Safe State Management for TypeScript">
      <Head>
        <title>Store | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
