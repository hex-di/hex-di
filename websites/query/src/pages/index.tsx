...
const INSTALL_CMD = "npm install @hex-di/query";
const ACCENT = "#00C4D4";
...
const FEATURES: Feature[] = [
  ...
  {
    title: "Pagination",
    description: "Cursor-based and offset pagination with type-safe page tokens.",
  },
  {
    title: "Port-Based",
    description:
  ...
  },
  {
    ...
    description: "useQuery and useMutation hooks that resolve from your DI graph.",
  },
  {
    title: "Deduplication",
    description: "Identical in-flight queries are merged. No duplicate network requests.",
  },
];
  ...
  return (
    <section className="hero-section">
      ...
      >
        ...
        >
          Type-Safe Data Querying for TypeScript
        </p>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          ...
          <p style={{ ...S.body(), maxWidth: 560, margin: "0 auto 32px" }}>
            Query integrates seamlessly with the HexDI dependency injection ecosystem. Use it
...
export default function Home(): React.ReactNode {
  return (
    <Layout description="Type-Safe Data Querying for TypeScript">
      <Head>
        <title>Query | HexDI</title>
      </Head>
      <main>
        <Hero />
        <Features />
