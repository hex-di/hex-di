    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Catch missing dependencies at compile time, not in production. HexDI encodes your entire
            dependency graph into TypeScript types — missing adapters are type errors, not runtime
            crashes.
          </p>
        ...
        {STATS.map((stat, i) => (
          <FadeIn key={stat.label} delay={i * 60}>
            ...
            >
              ...
              <div style={{ ...S.body("#506070"), fontSize: "0.7rem", marginTop: "4px" }}>
                {stat.sub}
              </div>
            </div>
          </FadeIn>
      ...
      <div style={S.container()}>
        <div style={S.sectionHeader()}>
          ...
          <p style={{ ...S.body(), maxWidth: "480px", margin: "0 auto" }}>
            No decorators. No string tokens. No runtime magic. Just TypeScript types doing real
            work.
          </p>
        </div>
                ...
                <div style={{ marginBottom: "16px" }}>
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                    <polygon
                      ...
                      strokeWidth="1.5"
                      fill={
                        feature.accent === "cyan" ? "rgba(0,240,255,0.08)" : "rgba(255,94,0,0.08)"
                      }
                    />
                    <circle
                      cx="11"
          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  <span style={{ color: "rgba(255,100,100,0.9)", fontWeight: 700 }}>
                    {" "}
                    ERROR [HEX008]{"\n"}
                  </span>
                  <span style={{ color: "rgba(255,60,60,0.4)" }}>
                    {" "}
                    {"─".repeat(37)}
                    {"\n"}
                  </span>
...
const HEXDI_API = new Set(["port", "createAdapter", "createContainer", "GraphBuilder"]);
      ...
      >
        ...
        <FadeIn delay={0}>
          <div>
            ...
            <h2 style={S.h2()}>
              From scratch to <span style={{ color: "#00F0FF" }}>type-safe</span> in 5 steps
            </h2>
                  ...
                  {ECOSYSTEM.map(lib => (
                    <span
                      ...
                      style={{
                        ...
                        fontSize: "0.68rem",
                        color:
                          lib.accent === "cyan" ? "rgba(0,240,255,0.65)" : "rgba(255,94,0,0.65)",
                        background:
                          lib.accent === "cyan" ? "rgba(0,240,255,0.06)" : "rgba(255,94,0,0.06)",
  ...
  return (
    ...
    >
      <defs>
        ...
        {ECO_NODES.map(node => (
          ...
          >
            <stop
              offset="0%"
              stopColor={node.accent === "cyan" ? "rgba(0,240,255,0.05)" : "rgba(255,94,0,0.05)"}
            />
            <stop
              offset="100%"
              stopColor={node.accent === "cyan" ? "rgba(0,240,255,0.45)" : "rgba(255,94,0,0.45)"}
            />
          </linearGradient>
        ))}
        ...
        {/* .eco-spoke animation is defined in landing.css */}
      </defs>
      ...
      {ECO_NODES.map((node, i) => {
        ...
        return (
          <circle
            key={`p-${node.name}`}
            r={2}
            fill={node.accent === "cyan" ? "#00F0FF" : "#FF5E00"}
            opacity={0}
          >
            <animateMotion
              dur={`${PARTICLE_DUR}s`}
      ...
      {ECO_NODES.map(node => {
        ...
        const accentStroke =
          node.accent === "cyan" ? "rgba(0,240,255,0.50)" : "rgba(255,94,0,0.50)";
      ...
      <div style={S.container()}>
        <FadeIn>
          <div style={S.sectionHeader()}>
            ...
            <h2 style={S.h2()}>
              A full ecosystem, <span style={{ color: "#00F0FF" }}>wired through one graph</span>
            </h2>
            <p style={{ ...S.body(), maxWidth: "520px", margin: "0 auto" }}>
              Every library exposes its functionality as ports. Wire them through the same
              container, and each library&apos;s services are fully typed and resolvable alongside
              your own.
            </p>
          </div>
        </FadeIn>
